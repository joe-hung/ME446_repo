 ...
 * C source code generated on : Wed Oct 19 14:06:44 2022
 *
...
SLDRTBOARD SLDRTBoards[1] = {
  { "Standard_Devices/Serial_Port", 12U, 8, SLDRTBoardOptions0 },
};
  ...
  {
    {
      ...
      sendToAsyncQueueTgtAppSvc(133754488U, time, pData, size);
    }
  }
  ...
  {
    {
      ...
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(2898353812U, time, pData, size);
    }
  }
  ...
  {
    {
      ...
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(3317701252U, time, pData, size);
    }
  }
  ...
  {
    {
      ...
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(654183071U, time, pData, size);
    }
  }
...
RT_MODEL_simulink5ms_plotAndGains_T *simulink5ms_plotAndGains(void)
{
  ...
  /* External mode info */
  simulink5ms_plotAndGains_M->Sizes.checksums[0] = (4051292157U);
  simulink5ms_plotAndGains_M->Sizes.checksums[1] = (2410286977U);
  simulink5ms_plotAndGains_M->Sizes.checksums[2] = (4124335441U);
  simulink5ms_plotAndGains_M->Sizes.checksums[3] = (239505003U);
