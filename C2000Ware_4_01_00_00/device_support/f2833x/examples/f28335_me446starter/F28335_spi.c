...
void init_SPI(void){
    ...
    SpiaRegs.SPIBRR = 31;   // divide by 40 3.75 Mhz, 1.4.3 of SPI Guide
...
__interrupt void SPI_RXint(void) {
    ...
    case 5:
        ...
        PieCtrlRegs.PIEIFR12.bit.INTx6 = 1;  // Manually cause the interrupt for the SWI
